				...
				if ($atts['id'] == $data['counter']) {
					...
					$contents = '<div class="wcp-caption-plugin" id="wcp-widget-'.$atts['id'].'">';
						$contents .=    '<div class="image-caption-box">';  
					        $contents .= '<div class="caption '.$hoverstyle.'" style="background-color: '.$captionbg.'; color: '.$captioncolor.'; opacity: '.$captionopacity.';">  ';
						    	$contents .=    '<div class="centered-text" style="text-align: '.$captionalignment.'; padding: 5px;">'.$captiontext.'</div>';
					        $contents .= '</div>';  
