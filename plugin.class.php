...
?>
	...
	<p>
		...
		<select class="widefat" name="<?php echo $this->get_field_name('imagestyle'); ?>">
			...
			<option value="image-flip-up" <?php if($imagestyle == 'image-flip-up'){echo 'selected';} ?>><?php _e( 'Image flip up', 'image-caption-hover' ); ?></option>
			<option value="image-flip-down" <?php if($imagestyle == 'image-flip-down'){echo 'selected';} ?>><?php _e( 'Image flip down', 'image-caption-hover' ); ?></option>
			<option value="image-flip-right" <?php if($imagestyle == 'image-flip-right'){echo 'selected';} ?>><?php _e( 'Image flip right', 'image-caption-hover' ); ?></option>
			<option value="image-flip-left" <?php if($imagestyle == 'image-flip-left'){echo 'selected';} ?>><?php _e( 'Image flip left', 'image-caption-hover' ); ?></option>
			<option value="rotate-image-down" <?php if($imagestyle == 'rotate-image-down'){echo 'selected';} ?>><?php _e( 'Rotate image down', 'image-caption-hover' ); ?></option>
			<option value="image-turn-around" <?php if($imagestyle == 'image-turn-around'){echo 'selected';} ?>><?php _e( 'Image turn around', 'image-caption-hover' ); ?></option>
			<option value="zoom-and-pan" <?php if($imagestyle == 'zoom-and-pan'){echo 'selected';} ?>><?php _e( 'Zoom in', 'image-caption-hover' ); ?></option>
			<option value="tilt-image" <?php if($imagestyle == 'tilt-image'){echo 'selected';} ?>><?php _e( 'Image tilt', 'image-caption-hover' ); ?></option>
			<option value="morph" <?php if($imagestyle == 'morph'){echo 'selected';} ?>><?php _e( 'Morph', 'image-caption-hover' ); ?></option>
			<option value="move-image-right" <?php if($imagestyle == 'move-image-right'){echo 'selected';} ?>><?php _e( 'Move image right', 'image-caption-hover' ); ?></option>
			<option value="move-image-left" <?php if($imagestyle == 'move-image-left'){echo 'selected';} ?>><?php _e( 'Move image left', 'image-caption-hover' ); ?></option>
			<option value="move-image-top" <?php if($imagestyle == 'move-image-top'){echo 'selected';} ?>><?php _e( 'Move image top', 'image-caption-hover' ); ?></option>
			<option value="move-image-bottom" <?php if($imagestyle == 'move-image-bottom'){echo 'selected';} ?>><?php _e( 'Move image bottom', 'image-caption-hover' ); ?></option>
			<option value="image-squeez-right" <?php if($imagestyle == 'image-squeez-right'){echo 'selected';} ?>><?php _e( 'Image squeez right', 'image-caption-hover' ); ?></option>
			<option value="image-squeez-left" <?php if($imagestyle == 'image-squeez-left'){echo 'selected';} ?>><?php _e( 'Image squeez left', 'image-caption-hover' ); ?></option>
			<option value="image-squeez-top" <?php if($imagestyle == 'image-squeez-top'){echo 'selected';} ?>><?php _e( 'Image squeez top', 'image-caption-hover' ); ?></option>
			<option value="image-squeez-bottom" <?php if($imagestyle == 'image-squeez-bottom'){echo 'selected';} ?>><?php _e( 'Image squeez bottom', 'image-caption-hover' ); ?></option>
		</select>
	</p>
	<script>
