jQuery(document).ready( function(){
    ...
    jQuery('#accordion .btnadd').click(function(event) {
        ...
        parent_newly.find('.insert-picker-bg').append('<input type="text" class="captionbg colorpicker" value="#000000" />');
        parent_newly.find('.insert-picker-color').append('<input type="text" class="captioncolor colorpicker" value="#000000" />');
        ...
        parentdiv.find('.insert-preview').html('<div class="wcp-caption-plugin" id="wcp-caption1">\
                                <div class="image-caption-box">\
                                    <div class="caption '+hoverstyle+'" style="background-color: '+captionbg+'; color: '+captioncolor+'; opacity: '+captionopacity+';">\
                                        <div style="text-align: '+captionalignment+'; padding: 5px;">'+captiontext+'</div>\
                                    </div>\
